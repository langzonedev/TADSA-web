...
test('create/edit person, complete intake, project coordination and safe local deletion',()=>{
 ...
 const project=call('projects','POST',{requestId:req(),clientId:c.id,primaryRecordId:null,title:'Synthetic assessment',summary:'Check posture',kind:'Assessment',requiredSkills:['Assessment'],technicianId:'person-3',fundingStatus:'self',payerId:null,fundingNotes:''});assert.equal(project.clientName,p.name);
