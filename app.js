...
async function project(view, id) {
  ...
  const [projectOperations,projectLocation,adminDetails,adminOptions]=await Promise.all([api(`projects/${id}/operations`),api(`projects/${id}/location`),api(`projects/${id}/admin-details`),api('project-admin-options')]);
