...
async function project(view, id) {
  ...
  const subnav=el('div',undefined,'project-subnav');subnav.setAttribute('role','tablist');subnav.setAttribute('aria-label','Project section');view.append(subnav);
  ...
  const sections=[
    ...
    {label:'Team & funding',items:[['Team & funding','Team & funding']]},
    {label:'Files',items:[['Files','Project files'],['Print documents','Print documents']]},
    {label:'Costs & hours',items:[['Costs & invoices','Cost summary'],['Record hours','Record hours'],...(financeRelevant?[['Prepare invoices','Invoices']]:[])]},
  ...
  function draw(){
    ...
    more.textContent=section.label+' ▾';more.setAttribute('aria-label','Project sections: '+section.label);
